...
void init_display() {
    ...
    wbkgd(information_window, COLOR_PAIR(2));
...
void print_register_window() {
    mvwprintw(information_window, 0, 0,
              ...
              Context_instance.L, Context_instance.A, Context_instance.BC, Context_instance.DE, Context_instance.HL,
              Context_instance.AF, Context_instance.SP, Context_instance.PC, Context_instance.SF, Context_instance.ZF,
              Context_instance.HC, Context_instance.PV, Context_instance.NF, Context_instance.CF);
    wrefresh(information_window);
}
